...
void draw_static_mob(uint8_t mob_id, Renderer &ctx, float _animation_value, float radius, uint32_t flags) {
    ...
    switch(mob_id) {
        ...
        case MobId::kMassiveLadybug:
            ...
            ctx.fill();
            {
                ...
                ctx.clip();
                ctx.set_fill(0xff111111);
                SeedGenerator gen(flags * 374572 + 46237);
